...
Try {
	...
	[string]$appVendor = 'GIMP'
	[string]$appName = 'GIMP'
	[string]$appVersion = '2.8.22'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/6/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
				$exitCode = Execute-Process -Path "$dirFiles\gimp.exe" -Parameters '/VERYSILENT /CLOSEAPPLICATIONS' -WindowStyle 'Hidden' -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# <Perform Uninstallation tasks here>
				$exitCode = Execute-Process -Path "$envProgramFiles\GIMP 2\uninst\unins000.exe" -Parameters '/VERYSILENT' -WindowStyle 'Hidden' -PassThru
				If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
